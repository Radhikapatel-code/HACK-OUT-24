...
export class Pricing {
  ...
  @Input()
  plan1Feature2: string = 'Track inventory levels in real-time'
  @Input()
  ...
  @Input()
  plan2Feature2: string = 'Advanced analytics and reporting tools'
  @Input()
  ...
  @Input()
  plan3Feature1: string = 'Unlimited monitoring of agricultural products'
  @Input()
  plan2Feature3: string = 'Automated notifications for low inventory levels'
  @Input()
  ...
  @Input()
  plan3Feature2: string = 'Customizable alerts and notifications'
  @Input()
  content1: string = 'Choose the perfect plan for you'
  @Input()
  plan2Feature1: string =
    'Monitor up to 500 different types of agricultural products'
  @Input()
  ...
  @Input()
  plan1Feature3: string = 'List surplus supplies for sale on the platform'
  @Input()
  plan1Yearly: string = 'or $200 yearly'
  @Input()
  plan1Feature1: string =
    'Monitor up to 100 different types of agricultural products'
  @Input()
  plan3Feature3: string = 'Priority customer support'
  @Input()
  content2: string = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. '
  @Input()
  plan3Action1: string = 'Get started'
  @Input()
  plan1Price: string = '$19.99/month'
  @Input()
