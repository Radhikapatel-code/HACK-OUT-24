    ...
    <header data-thq="thq-navbar" class="navbar-navbar-interactive">
      ...
      <div data-thq="thq-navbar-nav" class="navbar-desktop-menu">
        ...
        <div class="navbar-buttons">
          <button class="navbar-action1 thq-button-animated thq-button-filled">
            <span class="thq-body-small">Action 1</span>
          </button>
          <button class="navbar-action2 thq-button-outline thq-button-animated">
...
export default {
  ...
  props: {
    ...
    logoAlt: {
      type: String,
      default: 'Farmers Warehouse Management',
    },
    link3: {
      type: String,
      default: 'List Surplus Supplies',
    },
    action1: {
      type: String,
      default: '/home',
