...
export default {
  ...
  props: {
    ...
    content3: {
      type: String,
      default: 'Designed and developed by FarmTech Solutions',
    },
    link4: {
      type: String,
    ...
    content2: {
      type: String,
      default: '© 2023 Farmers Warehouse Management. All rights reserved.',
    },
    link9: {
      type: String,
    ...
    logoAlt: {
      type: String,
      default: 'Farmers Warehouse Management Logo',
    },
    link1: {
      type: String,
      default: 'Home',
